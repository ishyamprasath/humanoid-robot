    ...
    return [
        types.Tool(
            function_declarations=[
                ...
                types.FunctionDeclaration(
                    name="turn_robot",
                    description=("Rotate the robot in place. Positive angle = clockwise (right), "
                ...
                types.FunctionDeclaration(
                    ...
                    parameters={
                        ...
                        "properties": {
                            "task_type": {
                                "type": "STRING",
                                "enum": ["fetch", "deliver", "inspect", "follow",
                                         "greet", "patrol", "return_home", "wait"],
                            },
                            "description": {
                                "type": "STRING",
                                "description": "One-line natural-language goal.",
                            },
                            "target_coordinates": {
                                "type": "OBJECT",
